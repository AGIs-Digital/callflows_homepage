...
export const metadata = generateMetadata({
  ...
  modifiedTime: "2024-03-06T10:00:00.000Z",
  authors: ["Timo Goltz"],
  keywords: [
    "KI Telefonie", 
    "Voice Agent", 
        ...
        <header className="mb-12">
          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-6">
            ...
            <div className="flex items-center gap-1">
              ...
              <time dateTime="2024-03-05T10:00:00Z">
                5. März 2024
              </time>
            </div>
            <div className="flex items-center gap-1">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground leading-tight">
            KI-Telefonie und Mitarbeiter: Wie man die Akzeptanz fördert
          </h1>
          
          <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
            Erfahren Sie, wie Sie Ihre Mitarbeiter für KI-Telefonie begeistern können. Praktische Tipps und Strategien für eine erfolgreiche Implementierung ohne Widerstände.
          </p>
