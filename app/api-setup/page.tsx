      ...
      <main className="bg-background min-h-screen flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Das API-Setup ist nur für Admin-Benutzer zugänglich
            </CardDescription>
          </CardHeader>
        ...
        <div className="container">
          ...
          <div className="mb-6">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>API Setup</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-primary mb-2">API Setup</h1>
                <p className="text-muted-foreground">
                  Konfigurieren Sie die Google APIs für echte SEO-Daten
                </p>
              </div>
