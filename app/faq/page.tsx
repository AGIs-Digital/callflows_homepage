...
// FAQ-Daten direkt aus Übersetzungen laden (Server-Side)
          ...
          <div className="container max-w-4xl relative z-10">
            ...
            <div className="text-center mb-12 mt-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
                {deTranslations.faq.pageTitle}
              </h1>
              
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                {deTranslations.faq.pageSubtitle}
              </p>
            </div>
            ...
            <Card className="mb-12 bg-[#fffffF]/90 backdrop-blur-sm border-primary/20 shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  {deTranslations.faq.description}
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="mt-12 bg-gradient-to-r from-[#fffff0] via-secondary/10 to-accent/10 border-primary/20 shadow-lg">
            <CardContent className="p-8 text-center">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                {deTranslations.faq.cta.title}
              </h2>
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                {deTranslations.faq.cta.description}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  {deTranslations.faq.cta.contactButton}
                </a>
                <a 
                  href="/pricing" 
                ...
                >
                  {deTranslations.faq.cta.pricingButton}
                </a>
              </div>
            </CardContent>
          </Card>
